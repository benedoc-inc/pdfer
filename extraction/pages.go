...
func ExtractPages(pdfBytes []byte, pdf *parser.PDF, verbose bool) ([]types.Page, error) {
...
func extractPagesFromTree(pdfBytes []byte, pdf *parser.PDF, pagesObjNum int, verbose bool) ([]types.Page, error) {
...
func extractPage(pdfBytes []byte, pdf *parser.PDF, pageObjNum int, pageStr string, verbose bool) (types.Page, error) {
	page := types.Page{
...
func parseContentStream(contentStr string, pdf *parser.PDF, pageNum int, verbose bool) ([]types.TextElement, []types.Graphic, []types.ImageRef) {
	// Will be implemented in content_stream.go
	return []types.TextElement{}, []types.Graphic{}, []types.ImageRef{}
}

func extractResources(resourcesStr string, pdf *parser.PDF, verbose bool) *types.PageResources {
...
func extractAnnotations(annotsStr string, pdf *parser.PDF, pageNum int, verbose bool) []types.Annotation {
